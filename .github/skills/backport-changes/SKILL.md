...
description: Analyze and backport changes from nightly to the release branch in dotnet/dotnet-docker. Use when asked about backporting, cherry-picking, reviewing nightly changes for a .NET containers release, or comparing branches.
user-invocable: true
