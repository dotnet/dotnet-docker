...
3.0.2-alpine3.10, 3.0-alpine3.10, 3.0.2-alpine, 3.0-alpine | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/3.0/aspnet/alpine3.10/amd64/Dockerfile) | Alpine 3.10
...
2.1.15-alpine3.10, 2.1-alpine3.10, 2.1.15-alpine, 2.1-alpine | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/2.1/aspnet/alpine3.10/amd64/Dockerfile) | Alpine 3.10
...
3.0.2-alpine3.10-arm64v8, 3.0-alpine3.10-arm64v8, 3.0.2-alpine-arm64v8, 3.0-alpine-arm64v8 | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/3.0/aspnet/alpine3.10/arm64v8/Dockerfile) | Alpine 3.10
