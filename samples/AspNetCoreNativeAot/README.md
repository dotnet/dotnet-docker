...
A similar console app sample supports [single file deployment](../ConsoleAppSelfContained/README.md) (non-AOT scenario). This app could also be deployed that way.
