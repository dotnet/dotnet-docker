...
namespace Microsoft.DotNet.Docker.Tests
{
    public static class TestData
    {
        ...
        {
            new ProductImageData { Version = V6_2, VersionFamily = V6_0, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Amd64 },
            new ProductImageData { Version = V6_2, VersionFamily = V6_0, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Arm64 },
            new ProductImageData { Version = V6_2, VersionFamily = V6_0, OS = OS.Mariner20,           OSTag = OS.Mariner,           Arch = Arch.Amd64 },
            new ProductImageData { Version = V6_2, VersionFamily = V6_0, OS = OS.Mariner20,           OSTag = OS.Mariner,           Arch = Arch.Arm64 },
            new ProductImageData { Version = V6_2, VersionFamily = V6_0, OS = OS.Mariner20Distroless, OSTag = OS.MarinerDistroless, Arch = Arch.Amd64 },
            new ProductImageData { Version = V6_2, VersionFamily = V6_0, OS = OS.Mariner20Distroless, OSTag = OS.MarinerDistroless, Arch = Arch.Arm64 },
