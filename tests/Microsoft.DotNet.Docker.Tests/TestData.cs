...
namespace Microsoft.DotNet.Docker.Tests
{
    public static class TestData
    {
        ...
        {
            new SampleImageData { OS = OSInfo.Alpine,           Arch = Arch.Amd64, DockerfileSuffix = "alpine",   IsPublished = true },
            new SampleImageData { OS = OSInfo.Alpine,           Arch = Arch.Arm,   DockerfileSuffix = "alpine",   IsPublished = true },
            new SampleImageData { OS = OSInfo.Alpine,           Arch = Arch.Arm64, DockerfileSuffix = "alpine",   IsPublished = true },
            ...
            new SampleImageData { OS = OSInfo.Alpine,           Arch = Arch.Arm64, DockerfileSuffix = "alpine" },
            new SampleImageData { OS = OSInfo.Alpine,           Arch = Arch.Amd64, DockerfileSuffix = "alpine" },
            new SampleImageData { OS = OSInfo.Alpine,           Arch = Arch.Arm64, DockerfileSuffix = "alpine-icu" },
            new SampleImageData { OS = OSInfo.Alpine,           Arch = Arch.Amd64, DockerfileSuffix = "alpine-icu" },
