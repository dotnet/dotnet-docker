...
namespace Microsoft.DotNet.Docker.Tests
{
    public static class TestData
    {
        ...
        {
            new() { Version = V6_0, OS = OS.BullseyeSlim,        Arch = Arch.Amd64 },
            new() { Version = V6_0, OS = OS.BookwormSlim,        Arch = Arch.Amd64 },
            new() { Version = V6_0, OS = OS.Focal,               Arch = Arch.Amd64 },
            new() { Version = V6_0, OS = OS.Jammy,               Arch = Arch.Amd64 },
            new() { Version = V6_0, OS = OS.JammyChiseled,       Arch = Arch.Amd64,   SdkOS = OS.Jammy },
            new() { Version = V6_0, OS = OS.Alpine318,           Arch = Arch.Amd64 },
            new() { Version = V6_0, OS = OS.Mariner20,           Arch = Arch.Amd64 },
            new() { Version = V6_0, OS = OS.Mariner20Distroless, Arch = Arch.Amd64,   SdkOS = OS.Mariner20 },

            new() { Version = V6_0, OS = OS.Mariner20,           Arch = Arch.Arm64 },
            new() { Version = V6_0, OS = OS.Mariner20Distroless, Arch = Arch.Arm64,   SdkOS = OS.Mariner20 },
            new() { Version = V6_0, OS = OS.BullseyeSlim,        Arch = Arch.Arm64 },
            new() { Version = V6_0, OS = OS.BookwormSlim,        Arch = Arch.Arm64 },
            new() { Version = V6_0, OS = OS.Focal,               Arch = Arch.Arm64 },
            new() { Version = V6_0, OS = OS.Jammy,               Arch = Arch.Arm64 },
            new() { Version = V6_0, OS = OS.JammyChiseled,       Arch = Arch.Arm64,   SdkOS = OS.Jammy },
            new() { Version = V6_0, OS = OS.Alpine318,           Arch = Arch.Arm64 },

            new() { Version = V6_0, OS = OS.BullseyeSlim,        Arch = Arch.Arm },
            new() { Version = V6_0, OS = OS.BookwormSlim,        Arch = Arch.Arm },
            new() { Version = V6_0, OS = OS.Focal,               Arch = Arch.Arm },
            new() { Version = V6_0, OS = OS.Jammy,               Arch = Arch.Arm },
            new() { Version = V6_0, OS = OS.JammyChiseled,       Arch = Arch.Arm,     SdkOS = OS.Jammy },
            new() { Version = V6_0, OS = OS.Alpine318,           Arch = Arch.Arm },


            new() { Version = V7_0, OS = OS.BullseyeSlim,        Arch = Arch.Amd64 },
            new() { Version = V7_0, OS = OS.BookwormSlim,        Arch = Arch.Amd64 },
            new() { Version = V7_0, OS = OS.Jammy,               Arch = Arch.Amd64 },
            new() { Version = V7_0, OS = OS.JammyChiseled,       Arch = Arch.Amd64,   SdkOS = OS.Jammy },
            new() { Version = V7_0, OS = OS.Alpine318,           Arch = Arch.Amd64 },
            new() { Version = V7_0, OS = OS.Mariner20,           Arch = Arch.Amd64 },
            new() { Version = V7_0, OS = OS.Mariner20Distroless, Arch = Arch.Amd64,   SdkOS = OS.Mariner20 },

            new() { Version = V7_0, OS = OS.Mariner20,           Arch = Arch.Arm64 },
            new() { Version = V7_0, OS = OS.Mariner20Distroless, Arch = Arch.Arm64,   SdkOS = OS.Mariner20 },
            new() { Version = V7_0, OS = OS.BullseyeSlim,        Arch = Arch.Arm64 },
            new() { Version = V7_0, OS = OS.BookwormSlim,        Arch = Arch.Arm64 },
            new() { Version = V7_0, OS = OS.Jammy,               Arch = Arch.Arm64 },
            new() { Version = V7_0, OS = OS.JammyChiseled,       Arch = Arch.Arm64,   SdkOS = OS.Jammy },
            new() { Version = V7_0, OS = OS.Alpine318,           Arch = Arch.Arm64 },

            new() { Version = V7_0, OS = OS.BullseyeSlim,        Arch = Arch.Arm },
            new() { Version = V7_0, OS = OS.BookwormSlim,        Arch = Arch.Arm },
            new() { Version = V7_0, OS = OS.Jammy,               Arch = Arch.Arm },
            new() { Version = V7_0, OS = OS.JammyChiseled,       Arch = Arch.Arm,     SdkOS = OS.Jammy },
            new() { Version = V7_0, OS = OS.Alpine318,           Arch = Arch.Arm },


            new() { Version = V8_0, OS = OS.BookwormSlim,        Arch = Arch.Amd64 },
            new() { Version = V8_0, OS = OS.Jammy,               Arch = Arch.Amd64 },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Amd64,   SdkOS = OS.Jammy },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Amd64,   SdkOS = OS.Jammy },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Amd64,   SdkOS = OS.Jammy,
            ...
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Amd64,   SdkOS = OS.Jammy, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Amd64 },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Amd64,   SdkOS = OS.Alpine318,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Amd64,   SdkOS = OS.Alpine318,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Amd64,   SdkOS = OS.Alpine318, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.Mariner20,           Arch = Arch.Amd64 },
            new() { Version = V8_0, OS = OS.Mariner20Distroless, Arch = Arch.Amd64,   SdkOS = OS.Mariner20 },
            new() { Version = V8_0, OS = OS.Mariner20Distroless, Arch = Arch.Amd64,   SdkOS = OS.Mariner20,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new() { Version = V8_0, OS = OS.Mariner20Distroless, Arch = Arch.Amd64,   SdkOS = OS.Mariner20,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.Mariner20Distroless, Arch = Arch.Amd64,   SdkOS = OS.Mariner20, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },

            new() { Version = V8_0, OS = OS.Mariner20,           Arch = Arch.Arm64 },
            new() { Version = V8_0, OS = OS.Mariner20Distroless, Arch = Arch.Arm64,   SdkOS = OS.Mariner20 },
            new() { Version = V8_0, OS = OS.Mariner20Distroless, Arch = Arch.Arm64,   SdkOS = OS.Mariner20,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new() { Version = V8_0, OS = OS.Mariner20Distroless, Arch = Arch.Arm64,   SdkOS = OS.Mariner20,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.Mariner20Distroless, Arch = Arch.Arm64,   SdkOS = OS.Mariner20, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.BookwormSlim,        Arch = Arch.Arm64 },
            new() { Version = V8_0, OS = OS.Jammy,               Arch = Arch.Arm64 },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Arm64,   SdkOS = OS.Jammy },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Arm64,   SdkOS = OS.Jammy,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Arm64,   SdkOS = OS.Jammy,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Arm64,   SdkOS = OS.Jammy, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Arm64 },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Arm64,   SdkOS = OS.Alpine318,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Arm64,   SdkOS = OS.Alpine318,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Arm64,   SdkOS = OS.Alpine318, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },

            new() { Version = V8_0, OS = OS.BookwormSlim,        Arch = Arch.Arm },
            new() { Version = V8_0, OS = OS.Jammy,               Arch = Arch.Arm },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Arm,     SdkOS = OS.Jammy },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Arm,     SdkOS = OS.Jammy,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Arm,     SdkOS = OS.Jammy,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.JammyChiseled,       Arch = Arch.Arm,     SdkOS = OS.Jammy, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Arm },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Arm,     SdkOS = OS.Alpine318, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Arm,     SdkOS = OS.Alpine318,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new() { Version = V8_0, OS = OS.Alpine318,           Arch = Arch.Arm,     SdkOS = OS.Alpine318, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps }
        };
        ...
        {
            new() { Version = V6_0, OS = OS.NanoServer1809,     Arch = Arch.Amd64 },
            new() { Version = V6_0, OS = OS.NanoServerLtsc2022, Arch = Arch.Amd64 },
            new() { Version = V6_0, OS = OS.ServerCoreLtsc2019, Arch = Arch.Amd64 },
            new() { Version = V6_0, OS = OS.ServerCoreLtsc2022, Arch = Arch.Amd64 },
            new() { Version = V7_0, OS = OS.NanoServer1809,     Arch = Arch.Amd64 },
            new() { Version = V7_0, OS = OS.NanoServerLtsc2022, Arch = Arch.Amd64 },
            new() { Version = V7_0, OS = OS.ServerCoreLtsc2019, Arch = Arch.Amd64 },
            new() { Version = V7_0, OS = OS.ServerCoreLtsc2022, Arch = Arch.Amd64 },
            new() { Version = V8_0, OS = OS.NanoServer1809,     Arch = Arch.Amd64 },
            new() { Version = V8_0, OS = OS.NanoServerLtsc2022, Arch = Arch.Amd64 },
            new() { Version = V8_0, OS = OS.ServerCoreLtsc2019, Arch = Arch.Amd64 },
            new() { Version = V8_0, OS = OS.ServerCoreLtsc2022, Arch = Arch.Amd64 },
        };
        ...
        private static readonly ProductImageData[] s_linuxMonitorTestData =
        {
            ...
            new ProductImageData { Version = V6_3, VersionFamily = V6_0, OS = OS.JammyChiseled,       OSTag = OS.UbuntuChiseled,    Arch = Arch.Amd64 },
            new ProductImageData { Version = V6_3, VersionFamily = V6_0, OS = OS.JammyChiseled,       OSTag = OS.UbuntuChiseled,    Arch = Arch.Arm64 },
