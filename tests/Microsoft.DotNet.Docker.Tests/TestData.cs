...
namespace Microsoft.DotNet.Docker.Tests
{
    public static class TestData
    {
        ...
        private static readonly MonitorImageData[] s_linuxMonitorTestData =
        {
            ...
            new MonitorImageData { Version = V6_2, RuntimeVersion = V6_0, OS = OS.JammyChiseled,       OSTag = OS.JammyChiseled,     Arch = Arch.Amd64 },
            new MonitorImageData { Version = V6_2, RuntimeVersion = V6_0, OS = OS.JammyChiseled,       OSTag = OS.JammyChiseled,     Arch = Arch.Arm64 },
            ...
            new MonitorImageData { Version = V7_0, RuntimeVersion = V7_0, OS = OS.JammyChiseled,       OSTag = OS.JammyChiseled,     Arch = Arch.Amd64 },
            new MonitorImageData { Version = V7_0, RuntimeVersion = V7_0, OS = OS.JammyChiseled,       OSTag = OS.JammyChiseled,     Arch = Arch.Arm64 },
