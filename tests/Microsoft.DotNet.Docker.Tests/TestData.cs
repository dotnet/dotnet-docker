...
namespace Microsoft.DotNet.Docker.Tests
{
    public static class TestData
    {
        private static readonly ProductImageData[] s_linuxTestData =
        {
            ...
            new ProductImageData { Version = V10_0, OS = OS.NobleChiseled,       Arch = Arch.Arm64,   SdkOS = OS.Noble,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps | DotNetImageRepo.Runtime | DotNetImageRepo.Aspnet },
            new ProductImageData { Version = V10_0, OS = OS.Alpine321,           Arch = Arch.Arm64 },
            new ProductImageData { Version = V10_0, OS = OS.Alpine321,           Arch = Arch.Arm64,   SdkOS = OS.Alpine321,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new ProductImageData { Version = V10_0, OS = OS.Alpine321,           Arch = Arch.Arm64,   SdkOS = OS.Alpine321,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            ...
            new ProductImageData { Version = V10_0, OS = OS.Alpine321,           Arch = Arch.Arm },
            new ProductImageData { Version = V10_0, OS = OS.Alpine321,           Arch = Arch.Arm,     SdkOS = OS.Alpine321,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new ProductImageData { Version = V10_0, OS = OS.Alpine321,           Arch = Arch.Arm,     SdkOS = OS.Alpine321,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
        ...
        [
            ...
            new ProductImageData { Version = V10_0_Preview, VersionFamily = V10_0, OS = OS.AzureLinux30Distroless, OSDir = OS.AzureLinuxDistroless, OSTag = "", Arch = Arch.Amd64,  SupportedImageRepos = DotNetImageRepo.Monitor | DotNetImageRepo.Monitor_Base },
            new ProductImageData { Version = V10_0_Preview, VersionFamily = V10_0, OS = OS.AzureLinux30Distroless, OSDir = OS.AzureLinuxDistroless, OSTag = "", Arch = Arch.Arm64,  SupportedImageRepos = DotNetImageRepo.Monitor | DotNetImageRepo.Monitor_Base },
        ];
