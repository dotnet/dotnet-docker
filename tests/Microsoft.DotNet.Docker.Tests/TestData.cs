...
namespace Microsoft.DotNet.Docker.Tests
{
    public static class TestData
    {
        ...
        {
            new ProductImageData { Version = V6_2, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Amd64 },
            new ProductImageData { Version = V6_2, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Arm64 },
            ...
            new ProductImageData { Version = V6_3, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Amd64 },
            new ProductImageData { Version = V6_3, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Arm64 },
            ...
            new ProductImageData { Version = V7_0, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Amd64 },
            new ProductImageData { Version = V7_0, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Arm64 },
