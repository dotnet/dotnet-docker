...
namespace Microsoft.DotNet.Docker.Tests
{
    public static class TestData
    {
        ...
        {
            new ProductImageData { Version = V6_2, VersionFamily = V6_0, OS = OS.Alpine316,           OSTag = OS.Alpine,            Arch = Arch.Amd64 },
            new ProductImageData { Version = V6_2, VersionFamily = V6_0, OS = OS.Alpine316,           OSTag = OS.Alpine,            Arch = Arch.Arm64 },
