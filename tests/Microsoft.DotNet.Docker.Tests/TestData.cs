...
namespace Microsoft.DotNet.Docker.Tests
{
    public static class TestData
    {
        ...
        private static readonly ProductImageData[] s_linuxMonitorTestData =
        {
            ...
            new ProductImageData { Version = V7_2, VersionFamily = V7_0, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Amd64 },
            new ProductImageData { Version = V7_2, VersionFamily = V7_0, OS = OS.Alpine317,           OSTag = OS.Alpine,            Arch = Arch.Arm64 },
