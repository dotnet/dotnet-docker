...
namespace Microsoft.DotNet.Docker.Tests
{
    public static class TestData
    {
        private static readonly ProductImageData[] s_linuxTestData =
        {
            ...
            // new ProductImageData { Version = V8_0, OS = OS.Noble,               Arch = Arch.Arm },
            // new ProductImageData { Version = V8_0, OS = OS.NobleChiseled,       Arch = Arch.Arm,     SdkOS = OS.Noble },
            // new ProductImageData { Version = V8_0, OS = OS.NobleChiseled,       Arch = Arch.Arm,     SdkOS = OS.Noble,
            //         ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            // new ProductImageData { Version = V8_0, OS = OS.NobleChiseled,       Arch = Arch.Arm,     SdkOS = OS.Noble,
            //         ImageVariant = DotNetImageVariant.Composite | DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Aspnet },
            // new ProductImageData { Version = V8_0, OS = OS.NobleChiseled,       Arch = Arch.Arm,     SdkOS = OS.Noble,
            //         ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps | DotNetImageRepo.Runtime | DotNetImageRepo.Aspnet },
            // new ProductImageData { Version = V8_0, OS = OS.NobleChiseled,       Arch = Arch.Arm,     SdkOS = OS.Noble, SdkImageVariant = DotNetImageVariant.AOT,
            //         ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            ...
            new ProductImageData { Version = V9_0, OS = OS.Alpine319,           Arch = Arch.Amd64,   SdkOS = OS.Alpine319,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new ProductImageData { Version = V9_0, OS = OS.Alpine319,           Arch = Arch.Amd64,   SdkOS = OS.Alpine319,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new ProductImageData { Version = V9_0, OS = OS.Alpine319,           Arch = Arch.Amd64,   SdkOS = OS.Alpine319, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            ...
            new ProductImageData { Version = V9_0, OS = OS.Alpine319,           Arch = Arch.Arm64,   SdkOS = OS.Alpine319,
                    ImageVariant = DotNetImageVariant.Composite, SupportedImageRepos = DotNetImageRepo.Aspnet },
            new ProductImageData { Version = V9_0, OS = OS.Alpine319,           Arch = Arch.Arm64,   SdkOS = OS.Alpine319,
                    ImageVariant = DotNetImageVariant.Extra, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
            new ProductImageData { Version = V9_0, OS = OS.Alpine319,           Arch = Arch.Arm64,   SdkOS = OS.Alpine319, SdkImageVariant = DotNetImageVariant.AOT,
                    ImageVariant = DotNetImageVariant.AOT, SupportedImageRepos = DotNetImageRepo.Runtime_Deps },
        ...
        private static readonly ProductImageData[] s_linuxMonitorTestData =
        {
            ...
            new ProductImageData { Version = V7_3, VersionFamily = V7_0, OS = OS.Alpine319,              OSTag = OS.Alpine,            Arch = Arch.Amd64,  SupportedImageRepos = DotNetImageRepo.Monitor },
            new ProductImageData { Version = V7_3, VersionFamily = V7_0, OS = OS.Alpine319,              OSTag = OS.Alpine,            Arch = Arch.Arm64,  SupportedImageRepos = DotNetImageRepo.Monitor },
