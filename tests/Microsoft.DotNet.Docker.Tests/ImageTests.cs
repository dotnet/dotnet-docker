...
namespace Microsoft.DotNet.Docker.Tests
{
    public class ImageTests
    {
        ...
        public void VerifySdkPackageCache(ImageData imageData)
        {
        ...
        [Theory]
        [MemberData(nameof(GetImageData))]
        public async Task VerifyRuntimeImage(ImageData imageData)
        {
        ...
        [Theory]
        [MemberData(nameof(GetImageData))]
        public async Task VerifyAspNetCoreRuntimeImage(ImageData imageData)
        {
            if (imageData.Version.Major == 1)
            {
