...
namespace Microsoft.DotNet.Docker.Tests
{
    public class ImageTests
    {
        ...
        private static readonly ImageData[] s_linuxTestData =
        {
            ...
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.BusterSlim, RuntimeDepsVersion = "2.1", SdkOsVariant = OS.Buster },
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.Bionic, RuntimeDepsVersion = "2.1" },
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.Alpine38, RuntimeDepsVersion = "2.1" },
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.StretchSlim, RuntimeDepsVersion = "2.1", SdkOsVariant = OS.Stretch, Architecture = "arm" },
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.BusterSlim, RuntimeDepsVersion = "2.1", SdkOsVariant = OS.Buster, Architecture = "arm" },
            ...
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.BusterSlim, RuntimeDepsVersion = "2.1", SdkOsVariant = OS.Buster, IsWeb = true },
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.Bionic, RuntimeDepsVersion = "2.1", IsWeb = true },
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.Alpine38, RuntimeDepsVersion = "2.1", IsWeb = true },
            ...
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.BusterSlim, RuntimeDepsVersion = "2.1", SdkOsVariant = OS.Buster, Architecture = "arm", IsWeb = true },
