...
1. Images will never be deleted from the [official .NET Docker repositories](https://mcr.microsoft.com/en-us/catalog?search=dotnet). This does not apply to the [nightly repositories](https://github.com/dotnet/dotnet-docker/blob/nightly/README.md).
