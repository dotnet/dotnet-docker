...
You can run a [sample application](https://hub.docker.com/r/microsoft/dotnet-samples/) that depends on these images in a container by running the following command.
