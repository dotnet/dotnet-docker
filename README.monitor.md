...
-----------| -------------| -------------
5.0.0-preview.1-alpine, 5.0-alpine, 5.0.0-preview.1, 5.0, latest | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/monitor/5.0/alpine/amd64/Dockerfile) | Alpine 3.12
