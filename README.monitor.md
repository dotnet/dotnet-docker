...
Tags | Dockerfile | OS Version
-----------| -------------| -------------
9.0.0-preview.4-amd64, 9.0-preview-amd64, 9.0.0-preview.4, 9.0-preview, 9-preview, latest | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/src/monitor/9.0/azurelinux-distroless/amd64/Dockerfile) | Azure Linux 3.0
...
Tags | Dockerfile | OS Version
-----------| -------------| -------------
9.0.0-preview.4-arm64v8, 9.0-preview-arm64v8, 9.0.0-preview.4, 9.0-preview, 9-preview, latest | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/src/monitor/9.0/azurelinux-distroless/arm64v8/Dockerfile) | Azure Linux 3.0
