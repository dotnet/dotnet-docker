...
Tags | Dockerfile | OS Version
-----------| -------------| -------------
9.1.0-preview.1, 9.1-preview, 9-preview, latest | [Dockerfile](src/monitor/9.1/azurelinux-distroless/amd64/Dockerfile) | Azure Linux 3.0
...
Tags | Dockerfile | OS Version
-----------| -------------| -------------
9.1.0-preview.1, 9.1-preview, 9-preview, latest | [Dockerfile](src/monitor/9.1/azurelinux-distroless/arm64v8/Dockerfile) | Azure Linux 3.0
