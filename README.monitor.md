...
6.3.7-alpine-amd64, 6.3-alpine-amd64, 6-alpine-amd64, 6.3.7-alpine, 6.3-alpine, 6-alpine, 6.3.7, 6.3, 6 | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/src/monitor/6.3/alpine/amd64/Dockerfile) | Alpine 3.19
...
6.3.7-alpine-arm64v8, 6.3-alpine-arm64v8, 6-alpine-arm64v8, 6.3.7-alpine, 6.3-alpine, 6-alpine, 6.3.7, 6.3, 6 | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/src/monitor/6.3/alpine/arm64v8/Dockerfile) | Alpine 3.19
