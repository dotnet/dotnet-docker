...
Tags | Dockerfile | OS Version
-----------| -------------| -------------
7.0.0-preview.3-alpine-amd64, 7.0-alpine-amd64, 7-alpine-amd64, 7.0.0-preview.3-alpine, 7.0-alpine, 7-alpine, 7.0.0-preview.3, 7.0, 7 | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/main/src/monitor/7.0/alpine/amd64/Dockerfile) | Alpine 3.15

## Linux arm64 Tags
##### .NET Monitor Preview Tags
Tags | Dockerfile | OS Version
-----------| -------------| -------------
7.0.0-preview.3-alpine-arm64v8, 7.0-alpine-arm64v8, 7-alpine-arm64v8, 7.0.0-preview.3-alpine, 7.0-alpine, 7-alpine, 7.0.0-preview.3, 7.0, 7 | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/main/src/monitor/7.0/alpine/arm64v8/Dockerfile) | Alpine 3.15
