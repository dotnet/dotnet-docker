...
-----------| -------------| -------------
9.0.5, 9.0, 9, latest | [Dockerfile](src/monitor/9.0/azurelinux-distroless/amd64/Dockerfile) | Azure Linux 3.0
...
Tags | Dockerfile | OS Version
-----------| -------------| -------------
9.0.5, 9.0, 9, latest | [Dockerfile](src/monitor/9.0/azurelinux-distroless/arm64v8/Dockerfile) | Azure Linux 3.0
