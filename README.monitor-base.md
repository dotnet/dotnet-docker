...
9.0.0-preview.3-azurelinux-distroless-amd64, 9.0-preview-azurelinux-distroless-amd64, 9.0.0-preview.3-azurelinux-distroless, 9.0-preview-azurelinux-distroless | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/src/monitor-base/9.0/azurelinux-distroless/amd64/Dockerfile) | Azure Linux 2.0-distroless
...
9.0.0-preview.3-azurelinux-distroless-arm64v8, 9.0-preview-azurelinux-distroless-arm64v8, 9.0.0-preview.3-azurelinux-distroless, 9.0-preview-azurelinux-distroless | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/src/monitor-base/9.0/azurelinux-distroless/arm64v8/Dockerfile) | Azure Linux 2.0-distroless
