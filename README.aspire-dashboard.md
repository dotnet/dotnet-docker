...
* `9.2-preview`
  * `docker pull mcr.microsoft.com/dotnet/nightly/aspire-dashboard:9.2-preview`
...
-----------| -------------| -------------
9.2.0-preview.1, 9.2-preview, 9-preview, latest | [Dockerfile](src/aspire-dashboard/9.2/azurelinux-distroless/amd64/Dockerfile) | Azure Linux 3.0

### Linux arm64 Tags

Tags | Dockerfile | OS Version
-----------| -------------| -------------
9.2.0-preview.1, 9.2-preview, 9-preview, latest | [Dockerfile](src/aspire-dashboard/9.2/azurelinux-distroless/arm64v8/Dockerfile) | Azure Linux 3.0
