...
-----------| -------------| -------------
8.0.0-preview.7-amd64, 8.0-preview-amd64, 8.0.0-preview.7, 8.0-preview, latest | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/src/aspire-dashboard/8.0/cbl-mariner-distroless/amd64/Dockerfile) | CBL-Mariner 2.0

## Linux arm64 Tags
##### .NET Aspire Dashboard Preview Tags
Tags | Dockerfile | OS Version
-----------| -------------| -------------
8.0.0-preview.7-arm64v8, 8.0-preview-arm64v8, 8.0.0-preview.7, 8.0-preview, latest | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/src/aspire-dashboard/8.0/cbl-mariner-distroless/arm64v8/Dockerfile) | CBL-Mariner 2.0
