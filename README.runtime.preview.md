...
Tag | Dockerfile
---------| ---------------
5.0.0-preview.4-nanoserver-2004, 5.0-nanoserver-2004, 5.0.0-preview.4, 5.0, latest | [Dockerfile](https://github.com/dotnet/dotnet-docker/blob/nightly/5.0/runtime/nanoserver-2004/amd64/Dockerfile)
