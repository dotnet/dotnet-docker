...
namespace Dotnet.Docker
{
    ...
    {
        private SpecificCommandOptions Options { get; } = options;
        ...
        private void PushToAzdoBranch(string commitMessage, string targetBranch)
        {
        ...
        private async Task CreateGitHubPullRequest(string commitMessage, PullRequestOptions prOptions, string branchSuffix)
        {
        ...
        private async Task UpdateExistingGitHubPullRequestAsync(
        ...
        /// </summary>
        private List<string> GetNonBotCommits(Repository repo, string targetBranchName)
        {
        ...
        /// </summary>
        private string BuildLocalUpdateCommand()
        {
            List<string> parts =
            [
