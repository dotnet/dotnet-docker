...
namespace Dotnet.Docker
{
    public class Options
    {
        ...
        public bool UpdateOnly => Email == null || Password == null || User == null;
        ...
        public Options(string dockerfileVersion, string[] productVersion, string channelName, string versionSourceName, string email, string password, string user,
            bool computeShas, bool stableBranding, string binarySas, string checksumSas, string branch, string org, string project, string repo)
        {
        ...
        public static IEnumerable<Symbol> GetCliSymbols() =>
            new Symbol[]
            {
                ...
                new Option<string>("--branch", () => "nightly", "Target branch where the PR is to be merged"),
