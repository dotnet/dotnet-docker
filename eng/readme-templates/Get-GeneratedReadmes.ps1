...
$onDockerfilesGenerated = {
    ...
    if ($(Get-DockerOs) -eq "linux" -and -not $Validate) {
        ...
        CopyReadme $ContainerName "README.blazor-gateway.md"
        ...
        CopyReadme $ContainerName ".portal-docs/docker-hub/README.blazor-gateway.md"
        ...
        CopyReadme $ContainerName ".portal-docs/mar/README.blazor-gateway.portal.md"
