...
$onDockerfilesGenerated = {
    ...
    if (-Not $Validate) {
        ...
        CopyReadme $ContainerName "README.reverse-proxy.md"
        ...
        CopyReadme $ContainerName ".portal-docs/docker-hub/README.reverse-proxy.md"
        ...
        CopyReadme $ContainerName ".portal-docs/mar/README.reverse-proxy.portal.md"
